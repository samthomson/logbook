...
// nipb0.ts
var nipb0_exports = {};
__export(nipb0_exports, {
  BlossomClient: () => BlossomClient,
  areServersEqual: () => areServersEqual,
  blossomURIFromURL: () => blossomURIFromURL,
  blossomURIToURL: () => blossomURIToURL,
  buildBlossomURI: () => buildBlossomURI,
  computeBlobSha256: () => computeBlobSha256,
  createAuthEvent: () => createAuthEvent,
  createDeleteAuth: () => createDeleteAuth,
  createDownloadAuth: () => createDownloadAuth,
  createListAuth: () => createListAuth,
  createMirrorAuth: () => createMirrorAuth,
  createUploadAuth: () => createUploadAuth,
  deleteBlob: () => deleteBlob,
  downloadBlob: () => downloadBlob,
  encodeAuthorizationHeader: () => encodeAuthorizationHeader,
  getAuthExpiration: () => getAuthExpiration,
  getAuthTagValues: () => getAuthTagValues,
  getBlobSize: () => getBlobSize,
  getBlobType: () => getBlobType,
  getExtension: () => getExtension,
  getHashFromURL: () => getHashFromURL,
  getMIMEType: () => getMIMEType,
  getServersFromServerListEvent: () => getServersFromServerListEvent,
  hasBlob: () => hasBlob,
  isAuthExpired: () => isAuthExpired,
  isSha256: () => isSha256,
  iterateBlobs: () => iterateBlobs,
  listBlobs: () => listBlobs,
  mirrorBlob: () => mirrorBlob,
  normalizeServerTag: () => normalizeServerTag,
  now: () => now,
  oneHour: () => oneHour,
  parseBlossomURI: () => parseBlossomURI,
  reportBlobs: () => reportBlobs,
  uploadBlob: () => uploadBlob
});
module.exports = __toCommonJS(nipb0_exports);
...
async function computeBlobSha256(blob) {
  ...
  const hash = import_sha2.sha256.create().update(new Uint8Array(buffer)).digest();
