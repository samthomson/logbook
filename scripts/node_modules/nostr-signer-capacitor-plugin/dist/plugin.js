var capacitorNostrSignerPlugin = (function (exports, core) {
    'use strict';

    const native = core.registerPlugin('NostrSignerPlugin');
    ...
    const buildPermissionsJson = (perms) => JSON.stringify(perms !== null && perms !== void 0 ? perms : []);
    ...
    exports.NostrSignerPlugin = NostrSignerPlugin;
    exports.buildPermissionsJson = buildPermissionsJson;
