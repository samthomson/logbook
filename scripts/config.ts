...
import { resolveFeedReadbackUrl } from './static-sync.ts'
...
/** Hosted endpoint read back before the feed release stage is acknowledged. */
export const FEED_READBACK_URL = resolveFeedReadbackUrl(
  BASE_URL,
  process.env.LOGBOOK_FEED_READBACK_URL,
)
