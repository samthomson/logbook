...
const modules = new Map([
  ...
  ['pool', `export function getPool(){return {subscribeMany(_relays,filter,handlers){if(filter?.kinds?.includes(4200))globalThis.__qaSegmentEvent=handlers.onevent;return {close(){}}}}}`],
  ['blossom', `
