...
export default function IssueTimeline({
  ...
  useEffect(() => {
    ...
    if (!refreshingSameIssue) {
      ...
      // Persist the parsed newsletter immediately. A retry must not overwrite a
      // fresher relay snapshot with the original cached props.
